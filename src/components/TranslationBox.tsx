      ...
      <div className="mt-16 flex-1 mb-6 flex flex-col gap-4 p-4">
        ...
        <AnimatePresence>
          {showTranscription && (
            ...
            >
              <div className="translation-box w-[calc(100vw-3rem)] mx-auto h-[8vh] p-3 sm:p-4 md:p-6">
        ...
        <div 
          ...
          className="translation-box w-[calc(100vw-3rem)] mx-auto h-[25vh] overflow-y-auto scrollbar-hide flex flex-col justify-end p-4"
        >
