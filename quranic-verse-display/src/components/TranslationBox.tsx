    ...
    <div className="h-screen bg-background p-6 flex flex-col overflow-hidden">
      ...
      <div className={`${isFullscreen ? 'mt-0 h-screen' : 'mt-16 h-[calc(100vh-4rem)]'} flex flex-col gap-4 p-4`}>
        ...
        <div className={`${showTranscription ? 'h-[calc(100%-15vh-1rem)]' : 'h-full'} flex flex-col lg:flex-row gap-4`}>
          ...
          {showCamera && (
            <div className="w-full lg:w-2/5 h-[30vh] lg:h-full bg-primary/5 rounded-xl flex items-center justify-center">
          ...
          >
            <div className="text-left translation-text text-fade-out-at-top">
              {lines.length > 0 ? (
